...
def generate_text(transformer, tokens_tensor, max_tokens_generated, eos_id, temperature=0.01, repetition_penalty=1.2):
    with torch.no_grad():
...
texto_input = "<SYSTEM>Você agora é DorothLM<USER>Quem é Leo Pate?<ASSISTANT>"
