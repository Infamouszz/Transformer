...
transformer = Transformer(epochs=50, batch_size=16, d_model=512, vocab_size=10263, causal_mask_size=2048, max_seq_len=512, num_blocks=6)
transformer.to(DEVICE)
dataloader = DataLoaderPackerLocal(base_path=f"/kaggle/working/DatasetAiSFT_FINAL", max_parts=1, seq_len=512, batch_size=1)
