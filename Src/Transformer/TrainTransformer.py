...
dataloader = DataLoaderPackerLocal(base_path=f"/kaggle/working/datasetai-sft/DatasetAiSFT", max_parts=70, seq_len=512, batch_size=16)
...
steps = 0
transformer.load_params(r"/kaggle/working/parameters.pt")
